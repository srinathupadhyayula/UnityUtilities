...
namespace Utilities.Conversion
{
    ...
    public class TypeConversionInstance
    {
        ...
        private readonly Dictionary<Type,  Dictionary<Type, object>> m_convertersDictionary = new();
        ...
        public void Register<TSource, TDestination>(Func<TSource, TDestination> conversion)
        {
            ...
            if(!m_convertersDictionary.TryGetValue(type, out Dictionary<Type, object> dict))
            {
        ...
        {
            if (m_convertersDictionary.TryGetValue(source, out Dictionary<Type, object> typeConvertors))
            {
        ...
        {
            Dictionary<Type, object> typeConvertors = m_convertersDictionary[typeof(TSource)];
