...
namespace Utilities.UIToolkit
{
    ...
    public static class VisualElementExtension
    {
        ...
        public static void SetPseudoState(this VisualElement visualElement, PseudoStates state)
        {
            ...
            PropertyInfo property = typeof(VisualElement).GetProperty("pseudoStates", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        {
            PropertyInfo property = typeof(VisualElement).GetProperty("pseudoStates", BindingFlags.Instance | BindingFlags.NonPublic);
            object res= property?.GetMethod?.Invoke(visualElement, new object[] { });
