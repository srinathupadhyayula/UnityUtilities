...
namespace Utilities.UIToolkit
{
    ...
    public static class UIElementsUtility
    {
        ...
        {
            Type uiElementsUtilityType = ReflectionUtility.FindType("UnityEngine.UIElements.UIElementsUtility");

            MethodInfo createEventMethodInfo = null;
            foreach (MethodInfo method in uiElementsUtilityType.GetMethods( BindingFlags.NonPublic | BindingFlags.Static))
            {
