...
namespace Utilities.Extensions
{
    ...
    public static partial class TransformExtensions
    {
        ...
        /// <returns></returns>
        public static Transform DestroyAllChildren(this Transform transform, bool activeOnly = false)
        {
            ...
            foreach (var child in children)
            {
                ...
                //Object.DestroyImmediate(child.gameObject); // Changing this to Destroy
