...
{
    /// <summary>
    /// <para> This is a utility class that converts the input to AssetPath.</para>
    /// </summary>
    /// <remarks>
    ...
    public static class AssetPathConverter
{
    ...
    private const string k_assetsFolderName = "Assets/";

    /// <summary>
    /// Takes the string from the Asset Path Attribute and converts it into
    /// a usable resources path.
    /// </summary>
    /// <param name="projectPath">Full path of the asset in project</param>
    ...
    public static string ConvertToResourcesPath(string projectPath)
    {
        ...
        int folderIndex = projectPath.IndexOf(k_resourcesFolderName, StringComparison.Ordinal);
        ...
        folderIndex += k_resourcesFolderName.Length;
