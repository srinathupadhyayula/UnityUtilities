...
namespace Utilities.PropertyDrawers
{
    ...
    {
        private const string k_invalidAnimatorControllerWarningMessage = "Target animator controller is null";
        private const string k_invalidTypeWarningMessage = "{0} must be an int or a string";
        ...
        protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            {
                DrawDefaultPropertyAndHelpBox(rect, property, k_invalidAnimatorControllerWarningMessage, MessageType.Warning);
                return;
            }
            ...
            switch (property.propertyType)
            {
                ...
                case SerializedPropertyType.String:
                    ...
                    break;
                default:
                    DrawDefaultPropertyAndHelpBox(rect, property, string.Format(k_invalidTypeWarningMessage, property.name), MessageType.Warning);
                    break;
            }
