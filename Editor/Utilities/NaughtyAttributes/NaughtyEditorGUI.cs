...
namespace Utilities
{
    ...
    {
        public const float INDENT_LENGTH = 15.0f;
        public const float HORIZONTAL_SPACING = 2.0f;

        private static GUIStyle s_buttonStyle = new(GUI.skin.button) { richText = true };
