...
namespace Utilities
{
    ...
    public static class PropertyUtility
    {
        ...
        public static bool IsEnabled(SerializedProperty property)
        {
            ...
            ConditionalAttribute enableIfAttribute = GetAttribute<ConditionalAttribute>(property);
        ...
        {
            ConditionalAttribute showIfAttribute = GetAttribute<ConditionalAttribute>(property);
